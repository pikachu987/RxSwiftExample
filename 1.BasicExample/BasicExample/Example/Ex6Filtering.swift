...
//        self.ignoreElements()
    ...
    func debounce() {
        Observable<Int>.interval(RxTimeInterval.milliseconds(600), scheduler: MainScheduler.instance).take(for: RxTimeInterval.seconds(3), scheduler: MainScheduler.instance)
    ...
    func throttle() {
        Observable<Int>.interval(RxTimeInterval.milliseconds(100), scheduler: MainScheduler.instance).take(20)
    ...
    func distinct() {
        ...
        Observable<Int>.interval(RxTimeInterval.milliseconds(100), scheduler: MainScheduler.instance).take(array.count)
    ...
    func sample() {
        Observable<Int>.interval(RxTimeInterval.milliseconds(100), scheduler: MainScheduler.instance).take(10)
            .sample(Observable<Int>.interval(RxTimeInterval.milliseconds(500), scheduler: MainScheduler.instance))
            .subscribe { print($0) }
            .disposed(by: self.disposeBag)
    }
